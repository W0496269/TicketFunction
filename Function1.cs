...
namespace TicketFunction
{
    public class Function1
    {
        ...
        public async Task Run([QueueTrigger("tickethub", Connection = "AzureWebJobsStorage")] QueueMessage message)
        {
            ...
            _logger.LogInformation($"Ticket details: {ticket.ConcertId}, {ticket.Email}, {ticket.Name}, {ticket.Phone}, {ticket.Quantity}, {ticket.CreditCard}, {ticket.Expiration}, {ticket.SecurityCode}, {ticket.Address}, {ticket.City}, {ticket.Province}, {ticket.PostalCode}, {ticket.Country}");
